...
export const Table: React.FC<TableProps> = ({ revealed, averageVote }) => {
  return (
    <div className="w-[400px] h-[150px] bg-blue-900/50 rounded-[100px] border-8 border-blue-900 flex flex-col items-center justify-center shadow-2xl backdrop-blur-sm relative">
      {revealed && averageVote && (
        <div className="top-4 bg-blue-600 px-4 py-2 rounded-full shadow-lg border border-blue-400">
